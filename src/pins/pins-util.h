...
extern char        *pins_get_state_name(model_t model, int idx);
extern char        *pins_get_state_label_name(model_t model, int idx);
extern char        *pins_get_edge_label_name(model_t model, int idx);
